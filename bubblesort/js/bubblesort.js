...
var $author$project$BubbleSort$init = function (_v0) {
	return _Utils_Tuple2(
		{
			boundary: 6,
		...
		A2(
			$elm$random$Random$generate,
			$author$project$BubbleSort$Init,
			A3(
...
var $author$project$BubbleSort$setFresh = function (msg) {
	if (msg.$ === 'Init') {
		return true;
	} else {
		return false;
...
var $author$project$BubbleSort$subscriptions = function (model) {
...
var $author$project$BSCore$reset = F2(
	function (array, index) {
		return _Utils_Tuple2(array, 0);
	});
var $author$project$BSCore$next = F3(
	function (arr, idx, boundary) {
		if (boundary > 1) {
			if (_Utils_cmp(idx, boundary - 1) < 0) {
				var _v0 = A2($author$project$BSCore$increment, arr, idx);
				var l_ = _v0.a;
				var i_ = _v0.b;
				return _Utils_Tuple3(l_, i_, boundary);
			} else {
				var _v1 = A2($author$project$BSCore$reset, arr, idx);
				var l_ = _v1.a;
				var i_ = _v1.b;
				return _Utils_Tuple3(l_, i_, boundary - 1);
			}
		} else {
			return _Utils_Tuple3(arr, idx, boundary);
		}
	});
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$BubbleSort$selects = F2(
	function (ci, nums) {
		return _Utils_eq(
			ci,
...
var $author$project$BubbleSort$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			case 'Next':
				var _v2 = A3($author$project$BSCore$next, numbers, iter, boundary);
				var numbers_ = _v2.a;
				var iter_ = _v2.b;
				var b_ = _v2.c;
				...
				var selections_ = A2(
					...
					iter,
					A2($author$project$BubbleSort$selects, iter_, numbers_));
				switch (selections_.$) {
					case 'BothSelected':
						var i = selections_.a;
						var j = selections_.b;
...
var $author$project$BubbleSort$viewNums = F3(
	function (nums, iter, bndry) {
		var msg = function (ci) {
			return $author$project$BubbleSort$NoMsg;
		};
		var lwidth = 1100;
		return A2(
			$elm$html$Html$div,
...
var $author$project$BubbleSort$viewVars = function (vars) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$BubbleSort$viewVars(
						_List_fromArray(
							[
								_Utils_Tuple2('index (i)', iter),
								_Utils_Tuple2('boundary (b)', boundary)
							])),
						A3($author$project$BubbleSort$viewNums, numbers, iter, boundary)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$BubbleSort$main = $elm$browser$Browser$element(
	{
		init: A3($author$project$Core$init, $elm$core$Basics$identity, $author$project$AnalyticsPort$analytics, $author$project$BubbleSort$init),
		subscriptions: $author$project$Core$subscriptions($author$project$BubbleSort$subscriptions),
		update: A6($author$project$Core$update, $elm$core$Basics$identity, $author$project$AnalyticsPort$analytics, $author$project$BubbleSort$update, $author$project$BubbleSort$setFresh, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
		view: $author$project$Core$view($author$project$BubbleSort$view)
	});
_Platform_export({'BubbleSort':{'init':$author$project$BubbleSort$main(
