...
var $author$project$BubbleSortManual$Init = function (a) {
	return {$: 'Init', a: a};
};
...
var $author$project$BubbleSortManual$init = function (_v0) {
	return _Utils_Tuple2(
		{
			boundary: 6,
			iter: 0,
		...
		A2(
			$elm$random$Random$generate,
			$author$project$BubbleSortManual$Init,
			A3(
...
var $author$project$BubbleSortManual$setFresh = function (msg) {
	if (msg.$ === 'Init') {
		return true;
	} else {
		return false;
...
var $author$project$BubbleSortManual$subscriptions = function (model) {
...
var $author$project$BubbleSortManual$getNthMaximum = F2(
	function (n, nums) {
		return A2(
...
var $author$project$BubbleSortManual$isSorted = function (nums) {
	return _Utils_eq(
		$elm$core$List$sort(nums),
		nums);
};
...
var $author$project$BubbleSortManual$update = F2(
	function (msg, model) {
		var _v0 = model;
		var iter = _v0.iter;
		...
		switch (msg.$) {
			...
			case 'DecBoundary':
				...
				var _v4 = ($author$project$BubbleSortManual$isSorted(endList) && (_Utils_eq(
					A2(
						$author$project$BubbleSortManual$getNthMaximum,
						($elm$core$List$length(numbers) - boundary) + 1,
						numbers),
					A2($elm_community$list_extra$List$Extra$getAt, boundary - 1, numbers)) && (boundary > 1))) ? (((boundary === 2) && (!iter)) ? _Utils_Tuple2(
					boundary - 1,
					_Utils_Tuple2('Decremented "b", Bubblesort completed', $author$project$Core$Prompt$PromptSuccess)) : _Utils_Tuple2(
					boundary - 1,
					_Utils_Tuple2('Decremented "b", please perform next operation', $author$project$Core$Prompt$PromptSuccess))) : ((boundary > 1) ? _Utils_Tuple2(
					boundary - 1,
					_Utils_Tuple2('Decremented "b", this operation might be incorrect', $author$project$Core$Prompt$PromptDanger)) : _Utils_Tuple2(
					boundary,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{boundary: boundary_, prompt: prompt_}),
					$elm$core$Platform$Cmd$none);
			case 'Init':
				var arr = msg.a;
				return _Utils_Tuple2(
...
var $author$project$BubbleSortManual$DecBoundary = {$: 'DecBoundary'};
var $author$project$BubbleSortManual$IncIter = {$: 'IncIter'};
var $author$project$BubbleSortManual$ResetIter = {$: 'ResetIter'};
var $author$project$BubbleSortManual$Swap = {$: 'Swap'};
...
var $author$project$BubbleSortManual$NoMsg = {$: 'NoMsg'};
...
var $author$project$BubbleSortManual$viewNums = F3(
	function (nums, iter, bndry) {
		var msg = function (ci) {
			return $author$project$BubbleSortManual$NoMsg;
		};
		var lwidth = 1100;
		return A2(
			$elm$html$Html$div,
...
var $author$project$BubbleSortManual$viewVars = function (vars) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$BubbleSortManual$view = function (model) {
	var _v0 = model;
	var numbers = _v0.numbers;
	var iter = _v0.iter;
	var boundary = _v0.boundary;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$BubbleSortManual$viewVars(
						_List_fromArray(
							[
								_Utils_Tuple2('index (i)', iter),
								_Utils_Tuple2('boundary (b)', boundary)
							])),
						A3($author$project$BubbleSortManual$viewNums, numbers, iter, boundary)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$BubbleSortManual$Swap),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$BubbleSortManual$IncIter),
								$elm$html$Html$Attributes$class('button__action--primary')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$BubbleSortManual$ResetIter),
								$elm$html$Html$Attributes$class('button__action--primary')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$BubbleSortManual$DecBoundary),
								$elm$html$Html$Attributes$class('button__action--primary')
							]),
						_List_fromArray(
							[
...
var $author$project$BubbleSortManual$main = $elm$browser$Browser$element(
	{
		init: A3($author$project$Core$init, $elm$core$Basics$identity, $author$project$AnalyticsPort$analytics, $author$project$BubbleSortManual$init),
		subscriptions: $author$project$Core$subscriptions($author$project$BubbleSortManual$subscriptions),
		update: A6($author$project$Core$update, $elm$core$Basics$identity, $author$project$AnalyticsPort$analytics, $author$project$BubbleSortManual$update, $author$project$BubbleSortManual$setFresh, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
		view: $author$project$Core$view($author$project$BubbleSortManual$view)
	});
_Platform_export({'BubbleSortManual':{'init':$author$project$BubbleSortManual$main(
