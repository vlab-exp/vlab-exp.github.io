...
var $author$project$AdjOrder$subscriptions = function (model) {
...
var $author$project$AdjOrder$deselect = F2(
	function (i, selections) {
		var selections_ = function (sel) {
			if (sel.$ === 'OneSelected') {
				var j = sel.a;
				return A2($author$project$BSCore$deselect, j, sel);
			} else {
				return sel;
			}
		}(
...
var $author$project$BSCore$ordered = F3(
	function (array, i, j) {
		...
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			var x = _v0.a.a;
			var y = _v0.b.a;
			return !A4($author$project$BSCore$outOfOrder, i, j, x, y);
		} else {
			return false;
		}
	});
var $author$project$BSCore$select = F2(
	function (i, selections) {
		switch (selections.$) {
			case 'NoneSelected':
				return $author$project$BSCore$OneSelected(i);
			case 'OneSelected':
				var j = selections.a;
				return A2($author$project$BSCore$BothSelected, j, i);
			default:
				var j = selections.a;
				var k = selections.b;
				return A2($author$project$BSCore$BothSelected, j, k);
		}
	});
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$BSCore$validIdx = F2(
	function (i, lst) {
		return (_Utils_cmp(
			i,
			$elm$core$List$length(lst)) < 0) && (i >= 0);
	});
var $author$project$BSCore$validSelections = F2(
	function (selections, nums) {
		switch (selections.$) {
			case 'NoneSelected':
				return true;
			case 'OneSelected':
				var i = selections.a;
				return A2($author$project$BSCore$validIdx, i, nums);
			default:
				var i = selections.a;
				var j = selections.b;
				return A2($author$project$BSCore$validIdx, i, nums) && A2($author$project$BSCore$validIdx, j, nums);
		}
	});
var $author$project$AdjOrder$select = F3(
	function (i, selections, numbers) {
		var selections_ = A2(
			$author$project$BSCore$select,
			i + 1,
			A2($author$project$BSCore$select, i, selections));
		switch (selections.$) {
			case 'NoneSelected':
				return A2($author$project$BSCore$validSelections, selections_, numbers) ? _Utils_Tuple2(
					selections_,
					function () {
...
var $author$project$AdjOrder$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			case 'AdjOrder':
				return _Utils_Tuple2(
					$author$project$AdjOrder$updateOrder(model),
					$elm$core$Platform$Cmd$none);
			case 'Select':
				var x = msg.a;
				var _v2 = A3($author$project$AdjOrder$select, x, selections, numbers);
			...
			case 'Deselect':
				var i = msg.a;
				var _v3 = A2($author$project$AdjOrder$deselect, i, selections);
...
var $author$project$AdjOrder$Select = function (a) {
	return {$: 'Select', a: a};
};
	...
	function (nums, selections) {
		var msg = function () {
			switch (selections.$) {
				case 'NoneSelected':
					return function (ci) {
						return $author$project$AdjOrder$Select(ci);
					};
				case 'OneSelected':
					var i = selections.a;
					return function (ci) {
						return _Utils_eq(ci, i) ? $author$project$AdjOrder$Deselect(ci) : $author$project$AdjOrder$Select(ci);
					};
				default:
					var i = selections.a;
					var j = selections.b;
					return function (ci) {
						return (_Utils_eq(ci, i) || _Utils_eq(ci, j)) ? $author$project$AdjOrder$Deselect(ci) : $author$project$AdjOrder$Select(ci);
					};
			}
		}();
		var lwidth = 1100;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$AdjOrder$viewNums, numbers, selections)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
