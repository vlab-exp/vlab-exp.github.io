...
var $author$project$MergeSystemAlgo$GotRandomArray = function (a) {
...
var $author$project$MergeSystemAlgo$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$MergeSystemAlgo$GotRandomArray,
					A2(
...
var $author$project$MergeSystemAlgo$isLeftGreater = F2(
	function (l, r) {
...
var $author$project$MergeSystemAlgo$move = F2(
	function (from, ml) {
		if (!from.b) {
...
var $author$project$MergeSystemAlgo$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'Next':
				...
				if (!_v1.a.b) {
					if (!_v1.b.b) {
						...
						var _v2 = A2($author$project$MergeSystemAlgo$move, model.secondList, model.mergedList);
						var sl = _v2.a;
						var ml = _v2.b;
						return _Utils_Tuple2(
							_Utils_update(
					...
					if (!_v1.b.b) {
						var _v3 = A2($author$project$MergeSystemAlgo$move, model.firstList, model.mergedList);
						var fl = _v3.a;
						var ml = _v3.b;
						return _Utils_Tuple2(
							_Utils_update(
						...
						if (!A2($author$project$MergeSystemAlgo$isLeftGreater, model.firstList, model.secondList)) {
							var _v4 = A2($author$project$MergeSystemAlgo$move, model.firstList, model.mergedList);
							var fl = _v4.a;
							var ml = _v4.b;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{firstList: fl, mergedList: ml}),
								$elm$core$Platform$Cmd$none);
						} else {
							var _v5 = A2($author$project$MergeSystemAlgo$move, model.secondList, model.mergedList);
							var sl = _v5.a;
							var ml = _v5.b;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{mergedList: ml, secondList: sl}),
								$elm$core$Platform$Cmd$none);
						}
					}
				}
...
var $author$project$MergeSystemAlgo$Next = {$: 'Next'};
var $author$project$MergeSystemAlgo$NoOp = {$: 'NoOp'};
...
var $author$project$MergeSystemAlgo$controls = function (complete) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						complete ? $author$project$MergeSystemAlgo$NoOp : $author$project$MergeSystemAlgo$Next),
						$elm$html$Html$Attributes$class(
						(!complete) ? 'bg-gray-600' : 'bg-gray-400'),
...
var $author$project$MergeSystemAlgo$arrayItem = function (v) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$MergeSystemAlgo$issorted = F2(
	function (l1, l2) {
		return A2(
			$elm$core$List$all,
			function (x) {
...
var $author$project$MergeSystemAlgo$listView = F2(
	function (label, lst) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									'bg-green-200',
									A2(
										$author$project$MergeSystemAlgo$issorted,
										lst,
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2(
								...
								A2($elm$core$List$map, $author$project$MergeSystemAlgo$arrayItem, lst)),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$span,
...
var $author$project$MergeSystemAlgo$prompt = function (p) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$MergeSystemAlgo$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Merge System: Algorithm')
					])),
				$author$project$MergeSystemAlgo$prompt(model.promptText),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2($author$project$MergeSystemAlgo$listView, 'left', model.firstList),
						A2($author$project$MergeSystemAlgo$listView, 'right', model.secondList)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2($author$project$MergeSystemAlgo$listView, 'merged', model.mergedList)
					])),
				function () {
				...
				if ((_v0.a.$ === 'Nothing') && (_v0.b.$ === 'Nothing')) {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
					return $author$project$MergeSystemAlgo$controls(true);
				} else {
					return $author$project$MergeSystemAlgo$controls(false);
				}
			}()
			]));
};
var $author$project$MergeSystemAlgo$main = $elm$browser$Browser$element(
	{
		init: $author$project$MergeSystemAlgo$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$MergeSystemAlgo$update,
		view: $author$project$MergeSystemAlgo$view
	});
_Platform_export({'MergeSystemAlgo':{'init':$author$project$MergeSystemAlgo$main(
