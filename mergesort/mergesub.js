...
var $author$project$MS$M1$GotRandomArray = function (a) {
...
var $author$project$MS$M1$init = function (_v0) {
	return _Utils_Tuple2(
		{
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$MS$M1$GotRandomArray,
					A3(
...
var $author$project$MS$M1$subscriptions = function (_v0) {
...
var $author$project$MS$M1$removeIndex = F2(
	function (i, bounds) {
		return A2($elm$core$Set$remove, i, bounds);
	});
var $author$project$MS$M1$deselect = F2(
	function (i, model) {
		return _Utils_update(
			model,
			{
				bounds: A2($author$project$MS$M1$removeIndex, i, model.bounds)
			});
	});
...
var $author$project$MS$M1$sublist = F3(
	function (i, j, l) {
		return A2(
			$elm$core$List$map,
			function (_v1) {
...
var $author$project$MS$M1$mergeSublistsAt = F4(
	function (i, j, k, lst) {
		return $elm$core$List$concat(
			_List_fromArray(
				[
					A3($author$project$MS$M1$sublist, 0, i, lst),
					A2(
					$author$project$LMerge$merge,
					A3($author$project$MS$M1$sublist, i, j, lst),
					A3($author$project$MS$M1$sublist, j, k, lst)),
					A3(
					$author$project$MS$M1$sublist,
					k,
...
var $author$project$MS$M1$merge = function (model) {
	var _v0 = model;
	var lst = _v0.lst;
	...
	if (((indices.b && indices.b.b) && indices.b.b.b) && (!indices.b.b.b.b)) {
		...
		return _Utils_update(
			model,
			{
				...
				lst: A4($author$project$MS$M1$mergeSublistsAt, i, j, k, lst)
			});
	} else {
		return model;
	}
...
var $author$project$MS$M1$addIndex = F2(
	function (i, bounds) {
		return ($elm$core$Set$size(bounds) === 3) ? bounds : A2($elm$core$Set$insert, i, bounds);
	});
var $author$project$MS$M1$select = F2(
	function (i, model) {
		return _Utils_update(
			model,
			{
				bounds: A2($author$project$MS$M1$addIndex, i, model.bounds)
			});
	});
var $author$project$MS$M1$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Select':
				var i = msg.a;
				return _Utils_Tuple2(
					A2($author$project$MS$M1$select, i, model),
					$elm$core$Platform$Cmd$none);
			case 'Deselect':
				var j = msg.a;
				return _Utils_Tuple2(
					A2($author$project$MS$M1$deselect, j, model),
					$elm$core$Platform$Cmd$none);
			case 'Merge':
				return _Utils_Tuple2(
					$author$project$MS$M1$merge(model),
					$elm$core$Platform$Cmd$none);
			default:
				var a = msg.a;
				return _Utils_Tuple2(
...
var $author$project$MS$M1$Merge = {$: 'Merge'};
...
var $author$project$MS$M1$Deselect = function (a) {
	return {$: 'Deselect', a: a};
};
var $author$project$MS$M1$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$MS$M1$gridLine = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							isSelected ? $author$project$MS$M1$Deselect(position) : $author$project$MS$M1$Select(position))
						]),
					_List_Nil),
					A2(
					$elm$html$Html$div,
...
var $author$project$MS$M1$inbound = F2(
	function (i, bounds) {
...
var $author$project$MS$M1$selected = F2(
	function (i, bounds) {
		return A2($elm$core$Set$member, i, bounds);
	});
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$MS$M1$itemview = F4(
	function (val, index, length, indices) {
		return _Utils_eq(index, length - 1) ? A2(
			...
			_List_fromArray(
				[
					A2(
					$author$project$MS$M1$gridLine,
					index,
					A2($author$project$MS$M1$selected, index, indices)),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'background',
							A2($author$project$MS$M1$inbound, index, indices) ? '#F0F4C3' : '#ffffff')
						]),
					_List_fromArray(
						[
							A2(
					...
					$author$project$MS$M1$gridLine,
					index + 1,
					A2($author$project$MS$M1$selected, index + 1, indices))
				])) : A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$MS$M1$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$MS$M1$Merge),
...
var $author$project$MS$M1$main = $elm$browser$Browser$element(
	{init: $author$project$MS$M1$init, subscriptions: $author$project$MS$M1$subscriptions, update: $author$project$MS$M1$update, view: $author$project$MS$M1$view});
_Platform_export({'MS':{'M1':{'init':$author$project$MS$M1$main(
