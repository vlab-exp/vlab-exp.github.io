		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$MergeAlgo$GotRandomArray,
					A2(
...
var $author$project$MergeAlgo$isLeftGreater = F2(
	function (l, r) {
...
var $author$project$MergeAlgo$move = F2(
	function (from, ml) {
		if (!from.b) {
...
var $author$project$MergeAlgo$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'Next':
				...
				if (!_v1.a.b) {
					...
					if (!_v1.b.b) {
						var _v3 = A2($author$project$MergeAlgo$move, model.firstList, model.mergedList);
						var fl = _v3.a;
						var ml = _v3.b;
						return _Utils_Tuple2(
							_Utils_update(
						...
						if (!A2($author$project$MergeAlgo$isLeftGreater, model.firstList, model.secondList)) {
							var _v4 = A2($author$project$MergeAlgo$move, model.firstList, model.mergedList);
							var fl = _v4.a;
							var ml = _v4.b;
							return _Utils_Tuple2(
								_Utils_update(
							...
							var _v5 = A2($author$project$MergeAlgo$move, model.secondList, model.mergedList);
							var sl = _v5.a;
							var ml = _v5.b;
							return _Utils_Tuple2(
								_Utils_update(
...
var $author$project$MergeAlgo$Next = {$: 'Next'};
var $author$project$MergeAlgo$NoOp = {$: 'NoOp'};
...
var $author$project$MergeAlgo$controls = function (complete) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						complete ? $author$project$MergeAlgo$NoOp : $author$project$MergeAlgo$Next),
...
var $author$project$MergeAlgo$arrayItem = function (v) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$MergeAlgo$issorted = F2(
	function (l1, l2) {
		return A2(
			$elm$core$List$all,
			function (x) {
...
var $author$project$MergeAlgo$listView = F2(
	function (label, lst) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									'bg-green-200',
									A2(
										$author$project$MergeAlgo$issorted,
										lst,
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2(
								...
								A2($elm$core$List$map, $author$project$MergeAlgo$arrayItem, lst)),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$span,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$MergeAlgo$listView, 'left', model.firstList),
						A2($author$project$MergeAlgo$listView, 'right', model.secondList)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2($author$project$MergeAlgo$listView, 'merged', model.mergedList)
					])),
				function () {
				...
				if ((_v0.a.$ === 'Nothing') && (_v0.b.$ === 'Nothing')) {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
					return $author$project$MergeAlgo$controls(true);
				} else {
					return $author$project$MergeAlgo$controls(false);
				}
			}()
			]));
};
var $author$project$MergeAlgo$main = $elm$browser$Browser$element(
	{
		init: $author$project$MergeAlgo$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$MergeAlgo$update,
		view: $author$project$MergeAlgo$view
	});
_Platform_export({'MergeAlgo':{'init':$author$project$MergeAlgo$main(
