		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$MergeStrategy$GotRandomArray,
					A2(
...
var $author$project$MergeStrategy$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
...
var $author$project$MergeStrategy$arrayItem = function (v) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$MergeStrategy$issorted = F2(
	function (l1, l2) {
		return A2(
			$elm$core$List$all,
			function (x) {
...
var $author$project$MergeStrategy$listView = F2(
	function (label, lst) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									'bg-green-200',
									A2(
										$author$project$MergeStrategy$issorted,
										lst,
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2(
								...
								A2($elm$core$List$map, $author$project$MergeStrategy$arrayItem, lst)),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$span,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$MergeStrategy$listView, 'left', model.firstList),
						A2($author$project$MergeStrategy$listView, 'right', model.secondList)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$MergeStrategy$main = $elm$browser$Browser$element(
	{
		init: $author$project$MergeStrategy$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$MergeStrategy$update,
		view: $author$project$MergeStrategy$view
	});
_Platform_export({'MergeStrategy':{'init':$author$project$MergeStrategy$main(
