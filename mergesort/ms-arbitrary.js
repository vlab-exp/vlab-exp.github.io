...
var $author$project$MsArbitraryGraph$Point = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var $author$project$MsArbitraryGraph$defEdVal = {
	label: '',
	points: _List_fromArray(
		[
			A2($author$project$MsArbitraryGraph$Point, 0, 0)
		])
};
var $author$project$Config$opNodeHeight = 50;
var $author$project$Config$opNodeWidth = 150;
var $author$project$MsArbitraryGraph$defNodeVal = {height: $author$project$Config$opNodeHeight, label: '', width: $author$project$Config$opNodeWidth, x: 0, y: 0};
var $author$project$MsArbitrary$defaultGDOptions = {compound: false, directed: true, multigraph: false};
...
var $author$project$MsArbitraryGraph$nodeFromLabelVal = function (lst) {
	return {
...
var $author$project$MsArbitrary$ig1 = function (data) {
	return {
		edges: _List_fromArray(
			[
				{v: '$', value: $author$project$MsArbitraryGraph$defEdVal, w: 'split_n_$'}
			]),
		nodes: _List_fromArray(
			[
				{
				v: '$',
				value: $author$project$MsArbitraryGraph$nodeFromLabelVal(data)
			},
				{
				v: 'split_n_$',
				value: _Utils_update(
		...
		options: $author$project$MsArbitrary$defaultGDOptions,
...
var $author$project$MsArbitrary$init = function (flags) {
	return _Utils_Tuple2(
		{
			data: _List_Nil,
...
var $author$project$MsArbitrary$Recv = function (a) {
	return {$: 'Recv', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$MsArbitrary$messageReceiver = _Platform_incomingPort('messageReceiver', $elm$json$Json$Decode$string);
...
var $author$project$MsArbitraryGraph$pointEncode = function (p) {
...
var $author$project$MsArbitraryGraph$evEncode = function (ev) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'points',
				A2($elm$json$Json$Encode$list, $author$project$MsArbitraryGraph$pointEncode, ev.points))
			]));
};
var $author$project$MsArbitraryGraph$gdEdgeEncode = function (gde) {
	var _v0 = gde;
	var value = _v0.value;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'value',
				$author$project$MsArbitraryGraph$evEncode(value))
			]));
};
var $author$project$MsArbitraryGraph$nvEncode = function (nv) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$MsArbitraryGraph$gdNodeEncode = function (gdn) {
	var _v0 = gdn;
	var value = _v0.value;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'value',
				$author$project$MsArbitraryGraph$nvEncode(value))
			]));
};
var $elm$json$Json$Encode$bool = _Json_wrap;
var $author$project$MsArbitraryGraph$gdOptionEncode = function (gdo) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$MsArbitraryGraph$gdEncode = function (gd) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'options',
				$author$project$MsArbitraryGraph$gdOptionEncode(gd.options)),
				_Utils_Tuple2(
				'nodes',
				$elm$json$Json$Encode$list($author$project$MsArbitraryGraph$gdNodeEncode)(gd.nodes)),
				_Utils_Tuple2(
				'edges',
				$elm$json$Json$Encode$list($author$project$MsArbitraryGraph$gdEdgeEncode)(gd.edges)),
				_Utils_Tuple2(
				'value',
...
var $author$project$MsArbitraryGraph$GData = F4(
	function (options, nodes, edges, value) {
		return {edges: edges, nodes: nodes, options: options, value: value};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$MsArbitraryGraph$GDataEdge = F3(
	function (v, w, value) {
		return {v: v, value: value, w: w};
	});
var $author$project$MsArbitraryGraph$EdgeValue = F2(
	function (label, points) {
		return {label: label, points: points};
	});
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $author$project$MsArbitraryGraph$pointDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$MsArbitraryGraph$Point,
	A2($elm$json$Json$Decode$field, 'x', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'y', $elm$json$Json$Decode$float));
var $author$project$MsArbitraryGraph$evDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$MsArbitraryGraph$EdgeValue,
	A2($elm$json$Json$Decode$field, 'label', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'points',
		$elm$json$Json$Decode$list($author$project$MsArbitraryGraph$pointDecoder)));
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$MsArbitraryGraph$gdEdgeDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$MsArbitraryGraph$GDataEdge,
	A2($elm$json$Json$Decode$field, 'v', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'w', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'value', $author$project$MsArbitraryGraph$evDecoder));
var $author$project$MsArbitraryGraph$GDataNode = F2(
	function (v, value) {
		return {v: v, value: value};
	});
var $author$project$MsArbitraryGraph$NodeValue = F5(
	function (label, width, height, x, y) {
		return {height: height, label: label, width: width, x: x, y: y};
	});
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$MsArbitraryGraph$nvDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$MsArbitraryGraph$NodeValue,
	A2($elm$json$Json$Decode$field, 'label', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'height', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'x', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'y', $elm$json$Json$Decode$float));
var $author$project$MsArbitraryGraph$gdNodeDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$MsArbitraryGraph$GDataNode,
	A2($elm$json$Json$Decode$field, 'v', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'value', $author$project$MsArbitraryGraph$nvDecoder));
var $author$project$MsArbitraryGraph$GDataOptions = F3(
	function (directed, multigraph, compound) {
		return {compound: compound, directed: directed, multigraph: multigraph};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$MsArbitraryGraph$gdOptionDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$MsArbitraryGraph$GDataOptions,
...
var $author$project$MsArbitraryGraph$Dims = F2(
	function (width, height) {
		return {height: height, width: width};
	});
var $author$project$MsArbitraryGraph$gdimDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$MsArbitraryGraph$Dims,
	A2($elm$json$Json$Decode$field, 'height', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$float));
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$MsArbitraryGraph$gdataDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$MsArbitraryGraph$GData,
	A2($elm$json$Json$Decode$field, 'options', $author$project$MsArbitraryGraph$gdOptionDecoder),
	A2(
		$elm$json$Json$Decode$field,
		'nodes',
		$elm$json$Json$Decode$list($author$project$MsArbitraryGraph$gdNodeDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'edges',
...
var $author$project$MsArbitraryGraph$getData = F2(
	function (p, nl) {
		...
		if (_v0.$ === 'Just') {
			var n = _v0.a;
			return $author$project$MsArbitraryGraph$labelToData(n.value.label);
		} else {
			return _List_Nil;
		}
	});
...
var $author$project$MsArbitraryGraph$mergeArbitrary = F4(
	function (p1, p2, nl, el) {
		var mnv = A2(
			$elm$core$String$join,
			'+',
			A2(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						function (n) {
							return _Utils_eq('merge_n_' + (p1 + ('_' + p2)), n.v) ? _Utils_update(
								n,
								{v: 'merge_a_' + (p1 + ('_' + p2))}) : (_Utils_eq('merge_n_' + (p2 + ('_' + p1)), n.v) ? _Utils_update(
								n,
								{v: 'merge_a_' + (p2 + ('_' + p1))}) : n);
						},
						function (n) {
							return _Utils_eq(n.v, p1) ? _Utils_update(
								n,
								{v: p1 + '/m'}) : (_Utils_eq(n.v, p2) ? _Utils_update(
								n,
								{v: p2 + '/m'}) : n);
						}),
					nl),
				_List_fromArray(
					[
						{
						v: mnv,
						value: $author$project$MsArbitraryGraph$nodeFromLabelVal(
							A2(
								$author$project$LMerge$merge,
								A2($author$project$MsArbitraryGraph$getData, p1, nl),
								A2($author$project$MsArbitraryGraph$getData, p2, nl)))
					}
					])),
			A2(
				$elm$core$List$append,
				A2(
					...
					A2(
						$elm$core$Basics$composeR,
						function (e) {
							return _Utils_eq('merge_n_' + (p1 + ('_' + p2)), e.w) ? _Utils_update(
								e,
								{w: 'merge_a_' + (p1 + ('_' + p2))}) : (_Utils_eq('merge_n_' + (p2 + ('_' + p1)), e.w) ? _Utils_update(
								e,
								{w: 'merge_a_' + (p2 + ('_' + p1))}) : e);
						},
						A2(
							$elm$core$Basics$composeR,
							function (e) {
								return _Utils_eq(e.v, p1) ? _Utils_update(
									e,
									{v: p1 + '/m'}) : (_Utils_eq(e.v, p2) ? _Utils_update(
									e,
									{v: p2 + '/m'}) : e);
							},
							function (e) {
								return _Utils_eq(e.w, p1) ? _Utils_update(
									e,
									{w: p1 + '/m'}) : (_Utils_eq(e.w, p2) ? _Utils_update(
									e,
									{w: p2 + '/m'}) : e);
							})),
					el),
					...
					[
						...
						v: A2(
							...
							A2(
								...
								nl)) ? ('merge_a_' + (p1 + ('_' + p2))) : ('merge_a_' + (p2 + ('_' + p1))),
						value: $author$project$MsArbitraryGraph$defEdVal,
						w: mnv
					}
					])));
	});
...
var $author$project$MsArbitrary$sendMessage = _Platform_outgoingPort('sendMessage', $elm$core$Basics$identity);
...
var $author$project$MsArbitraryGraph$split_end = F5(
	function (toSplit, splitIdx, path, nodes, edges) {
		return _Utils_Tuple2(
			A2(
				$elm$core$List$append,
				_List_fromArray(
			...
			A2(
				...
				_List_fromArray(
					[
						{v: 'split_a_' + path, value: $author$project$MsArbitraryGraph$defEdVal, w: path + '-l'},
						{v: 'split_a_' + path, value: $author$project$MsArbitraryGraph$defEdVal, w: path + '-r'}
					]),
				A2(
					$elm$core$List$map,
					function (e) {
...
var $author$project$MsArbitraryGraph$split = F3(
	function (path, nodes, edges) {
		...
		var leftval = A2($elm$core$List$take, splitIdx, toSplit);
		var rightval = A2($elm$core$List$drop, splitIdx, toSplit);
		return (dlen <= 1) ? _Utils_Tuple2(nodes, edges) : ((dlen === 2) ? A5($author$project$MsArbitraryGraph$split_end, toSplit, splitIdx, path, nodes, edges) : _Utils_Tuple2(
			$elm$core$List$concat(
				_List_fromArray(
					[
						($elm$core$List$length(leftval) === 1) ? _List_Nil : _List_fromArray(
						[
							{
							v: 'split_n_' + (path + '-l'),
							value: _Utils_update(
						...
						($elm$core$List$length(rightval) === 1) ? _List_Nil : _List_fromArray(
						[
							{
							v: 'split_n_' + (path + '-r'),
							value: _Utils_update(
						...
						[
							{
							v: path + '-l',
							value: $author$project$MsArbitraryGraph$nodeFromLabelVal(leftval)
						},
							{
							v: path + '-r',
							value: $author$project$MsArbitraryGraph$nodeFromLabelVal(rightval)
						}
						]),
						A2(
						$elm$core$List$map,
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						($elm$core$List$length(leftval) === 1) ? _List_Nil : _List_fromArray(
						[
							{v: path + '-l', value: $author$project$MsArbitraryGraph$defEdVal, w: 'split_n_' + (path + '-l')}
						]),
						($elm$core$List$length(rightval) === 1) ? _List_Nil : _List_fromArray(
						[
							{v: path + '-r', value: $author$project$MsArbitraryGraph$defEdVal, w: 'split_n_' + (path + '-r')}
						]),
						A2(
						$elm$core$List$map,
						function (e) {
...
var $author$project$MsArbitrary$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Send':
				return _Utils_Tuple2(
					...
					$author$project$MsArbitrary$sendMessage(
						$author$project$MsArbitraryGraph$gdEncode(model.graph)));
			case 'Recv':
				var message = msg.a;
				var res = A2($elm$json$Json$Decode$decodeString, $author$project$MsArbitraryGraph$gdataDecoder, message);
				if (res.$ === 'Ok') {
					var gdata = res.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'GotRandomArray':
				var arr = msg.a;
				var gr_ = $author$project$MsArbitrary$ig1(
			...
			case 'Split':
				...
				var _v2 = model;
				var graph = _v2.graph;
				var _v3 = A3($author$project$MsArbitraryGraph$split, np, graph.nodes, graph.edges);
				var n_ = _v3.a;
				var e_ = _v3.b;
			...
			case 'Merge':
				...
				var _v4 = model;
				var graph = _v4.graph;
				var selectedNodes = _v4.selectedNodes;
				var _v5 = A4(
					$author$project$MsArbitraryGraph$mergeArbitrary,
					A2($elm$core$Maybe$withDefault, '', selectedNodes.a),
					A2($elm$core$Maybe$withDefault, '', selectedNodes.b),
					graph.nodes,
					graph.edges);
				var n_ = _v5.a;
				var e_ = _v5.b;
...
var $author$project$MsArbitraryGraph$pointToString = function (pt) {
...
var $author$project$MsArbitraryGraph$pointsToString = function (pts) {
	return A2(
		$elm$core$String$join,
		' ',
		A2($elm$core$List$map, $author$project$MsArbitraryGraph$pointToString, pts));
};
var $elm$svg$Svg$polygon = $elm$svg$Svg$trustedNode('polygon');
var $elm$svg$Svg$polyline = $elm$svg$Svg$trustedNode('polyline');
var $elm$svg$Svg$Attributes$stroke = _VirtualDom_attribute('stroke');
var $elm$svg$Svg$Attributes$strokeWidth = _VirtualDom_attribute('stroke-width');
var $author$project$MsArbitrary$viewEdge = function (edge) {
	var _v0 = edge;
	var value = _v0.value;
	var end = A2(
		$elm$core$Maybe$withDefault,
	...
	var start = A2(
		$elm$core$Maybe$withDefault,
		A2($author$project$MsArbitraryGraph$Point, 0, 0),
		$elm$core$List$head(value.points));
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$MsArbitraryGraph$pointsToString(
							_List_fromArray(
								[
									start,
									_Utils_update(
						...
						$author$project$MsArbitraryGraph$pointsToString(
							_List_fromArray(
								[
									...
									A2($author$project$MsArbitraryGraph$Point, end.x + 5, end.y - 10),
									A2($author$project$MsArbitraryGraph$Point, end.x - 5, end.y - 10),
									A2($author$project$MsArbitraryGraph$Point, end.x, end.y)
								])))
					]),
				_List_Nil)
			]));
...
var $author$project$MsArbitrary$SelectNode = function (a) {
...
var $author$project$MsArbitrary$viewDataNode = F3(
	function (node, selectedNodes, data) {
		var boxCol = function () {
			if (selectedNodes.a.$ === 'Just') {
				if (selectedNodes.b.$ === 'Just') {
					var a = selectedNodes.a.a;
					var b = selectedNodes.b.a;
					return A2(
						$elm$core$List$member,
						node.v,
						_List_fromArray(
		...
		var box = A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$fill(boxCol),
		...
		var txt = A2(
			...
			_List_fromArray(
				[
					...
					(A2($elm$core$String$contains, '+', node.v) || ($elm$core$List$length(
						$author$project$MsArbitraryGraph$labelToData(value.label)) === 1)) ? 'green' : 'black'),
		...
		return ((($elm$core$List$length(
			$author$project$MsArbitraryGraph$labelToData(value.label)) === 1) || A2($elm$core$String$contains, '+', node.v)) && ((!A2($elm$core$String$endsWith, '/m', node.v)) && (!_Utils_eq(
			$elm$core$List$length(
				$author$project$MsArbitraryGraph$labelToData(value.label)),
			$elm$core$List$length(data))))) ? A2(
			$elm$svg$Svg$g,
			_List_fromArray(
				[
					$elm$svg$Svg$Events$onClick(
					$author$project$MsArbitrary$SelectNode(node.v)),
...
var $author$project$MsArbitrary$viewNode = F3(
	function (node, selectedNodes, data) {
		var v = node.v;
		...
		if (vl.b) {
			if (!vl.b.b) {
				var kw = vl.a;
				return A3($author$project$MsArbitrary$viewDataNode, node, selectedNodes, data);
			} else {
				var lw = vl.a;
				var rest = vl.b;
				return $author$project$MsArbitrary$viewOpNode(node);
			}
		} else {
			return A2($elm$svg$Svg$rect, _List_Nil, _List_Nil);
		}
	});
var $author$project$MsArbitrary$viewGraph = function (_v0) {
	var graph = _v0.graph;
	var selectedNodes = _v0.selectedNodes;
	var data = _v0.data;
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					function (n) {
						return A3($author$project$MsArbitrary$viewNode, n, selectedNodes, data);
					},
					graph.nodes)),
				A2(
				$elm$svg$Svg$g,
				_List_Nil,
				A2($elm$core$List$map, $author$project$MsArbitrary$viewEdge, graph.edges))
			]));
};
...
_Platform_export({'MsArbitrary':{'init':$author$project$MsArbitrary$main(
