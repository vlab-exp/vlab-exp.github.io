...
var $author$project$DG3$expandgt2 = F3(
	function (path, nodes, edges) {
		...
		var exp_edges = _List_fromArray(
			[
				{v: path, value: $author$project$DG3$defEdVal, w: 'split_n_' + path},
				{v: 'split_n_' + path, value: $author$project$DG3$defEdVal, w: 'ms_n_' + (path + '-l')},
				{v: 'split_n_' + path, value: $author$project$DG3$defEdVal, w: 'ms_n_' + (path + '-r')},
...
var $author$project$DG3$split = F3(
	function (path, nodes, edges) {
		var toSplit = function () {
			var _v0 = A2(
				$elm_community$list_extra$List$Extra$find,
