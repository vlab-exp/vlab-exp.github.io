...
var $author$project$RandomWithoutReplacement$GotRandomArray = function (a) {
...
var $author$project$RandomWithoutReplacement$init = function (_v0) {
	return _Utils_Tuple2(
		{
		...
		A2(
			$elm$random$Random$generate,
			$author$project$RandomWithoutReplacement$GotRandomArray,
			A3(
...
var $author$project$RandomWithoutReplacement$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$RandomWithoutReplacement$GotTarget = function (a) {
...
var $author$project$RandomWithoutReplacement$select = F2(
	function (i, _v0) {
...
var $author$project$RandomWithoutReplacement$update = F2(
	function (msg, model) {
		var _v0 = model;
		var numbers = _v0.numbers;
		var selections = _v0.selections;
		...
		switch (msg.$) {
			case 'Select':
				var x = msg.a;
				var _v2 = A2($author$project$RandomWithoutReplacement$select, x, model);
			...
			case 'GotRandomArray':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$RandomWithoutReplacement$GotTarget,
						A2(
...
var $author$project$RandomWithoutReplacement$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$RandomWithoutReplacement$numberToBGColor = F4(
...
var $author$project$RandomWithoutReplacement$viewNums = F3(
	function (nums, selections, target) {
		var msg = function (ci) {
			return $author$project$RandomWithoutReplacement$Select(ci);
		};
		var lwidth = 1100;
		return A2(
			$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							A2(
								...
								F2(
									function (pos, n) {
										return A4($author$project$RandomWithoutReplacement$numberToBGColor, n, pos, selections, target);
									}),
								nums),
							selections,
							msg)
...
var $author$project$RandomWithoutReplacement$viewSearchTarget = function (target) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$RandomWithoutReplacement$view = function (model) {
	var _v0 = model;
	var numbers = _v0.numbers;
	var selections = _v0.selections;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$RandomWithoutReplacement$viewSearchTarget(target)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A3($author$project$RandomWithoutReplacement$viewNums, numbers, selections, target)
					]))
			]));
};
var $author$project$RandomWithoutReplacement$main = $elm$browser$Browser$element(
	{init: $author$project$RandomWithoutReplacement$init, subscriptions: $author$project$RandomWithoutReplacement$subscriptions, update: $author$project$RandomWithoutReplacement$update, view: $author$project$RandomWithoutReplacement$view});
_Platform_export({'RandomWithoutReplacement':{'init':$author$project$RandomWithoutReplacement$main(
