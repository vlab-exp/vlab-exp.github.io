...
var $author$project$RandomWithReplacement$GotRandomArray = function (a) {
	return {$: 'GotRandomArray', a: a};
};
var $author$project$RandomWithReplacement$NoneSelected = {$: 'NoneSelected'};
...
var $author$project$RandomWithReplacement$init = function (_v0) {
	return _Utils_Tuple2(
		{
			numbers: _List_fromArray(
				[10, 20, 50, 8, 30, 100, 5, 82]),
			prompt: _Utils_Tuple2('', $author$project$Prompt$PromptInfo),
			selections: $author$project$RandomWithReplacement$NoneSelected,
			target: 0
		},
		A2(
			$elm$random$Random$generate,
			$author$project$RandomWithReplacement$GotRandomArray,
			A3(
...
var $author$project$RandomWithReplacement$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$RandomWithReplacement$GotTarget = function (a) {
...
var $author$project$RandomWithReplacement$Selected = function (a) {
	return {$: 'Selected', a: a};
};
...
var $author$project$RandomWithReplacement$select = F2(
	function (i, _v0) {
		...
		var pm = function () {
			...
			if (_v1) {
				...
				return _Utils_Tuple2(
					'The item at index ' + ($elm$core$String$fromInt(i) + (' has number ' + ($elm$core$String$fromInt(ci) + ('. It does not match the search target of ' + ($elm$core$String$fromInt(target) + '. Please search other indices.'))))),
					$author$project$Prompt$PromptInfo);
			}
		}();
		return _Utils_Tuple2(
			$author$project$RandomWithReplacement$Selected(i),
			pm);
	});
var $author$project$RandomWithReplacement$update = F2(
	function (msg, model) {
		var _v0 = model;
		var numbers = _v0.numbers;
		var selections = _v0.selections;
		...
		switch (msg.$) {
			case 'Select':
				var x = msg.a;
				var _v2 = A2($author$project$RandomWithReplacement$select, x, model);
			...
			case 'GotRandomArray':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$RandomWithReplacement$GotTarget,
						A2(
...
var $author$project$RandomWithReplacement$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$RandomWithReplacement$selectionsList = function (selections) {
	if (selections.$ === 'NoneSelected') {
		return _List_Nil;
	} else {
		var i = selections.a;
		return _List_fromArray(
...
var $author$project$RandomWithReplacement$numberToBGColor = F4(
	function (num, idx, selections, target) {
		var sel_idx = A2(
			...
			A2(
				...
				0,
				$author$project$RandomWithReplacement$selectionsList(selections)));
		var label_ = function () {
...
var $author$project$RandomWithReplacement$viewNums = F3(
	function (nums, selections, target) {
		var msg = function (ci) {
			return $author$project$RandomWithReplacement$Select(ci);
		};
		var lwidth = 1100;
		return A2(
			$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							A2(
								...
								F2(
									function (pos, n) {
										return A4($author$project$RandomWithReplacement$numberToBGColor, n, pos, selections, target);
									}),
								nums),
							$author$project$RandomWithReplacement$selectionsList(selections),
							msg)
...
var $author$project$RandomWithReplacement$viewSearchTarget = function (target) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$RandomWithReplacement$view = function (model) {
	var _v0 = model;
	var numbers = _v0.numbers;
	var selections = _v0.selections;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$RandomWithReplacement$viewSearchTarget(target)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A3($author$project$RandomWithReplacement$viewNums, numbers, selections, target)
					]))
			]));
};
var $author$project$RandomWithReplacement$main = $elm$browser$Browser$element(
	{init: $author$project$RandomWithReplacement$init, subscriptions: $author$project$RandomWithReplacement$subscriptions, update: $author$project$RandomWithReplacement$update, view: $author$project$RandomWithReplacement$view});
_Platform_export({'RandomWithReplacement':{'init':$author$project$RandomWithReplacement$main(
