...
var $author$project$BinarySearch$GotRandomArray = function (a) {
	return {$: 'GotRandomArray', a: a};
};
var $author$project$Prompt$PromptInfo = {$: 'PromptInfo'};
var $author$project$BinarySearch$ShowAll = {$: 'ShowAll'};
...
var $author$project$BinarySearch$msgToString = function (m) {
	if (m.$ === 'ShowAll') {
		return 'Show All';
	} else {
		return '';
...
var $author$project$BinarySearch$init = function (_v0) {
	return _Utils_Tuple2(
		{
			ctrls: _List_fromArray(
				[
					{
					label: $author$project$BinarySearch$msgToString($author$project$BinarySearch$ShowAll),
					message: $author$project$BinarySearch$ShowAll,
					status: $author$project$Controls$Disabled,
					text: ''
				}
				]),
			iter: -1,
			...
			selectable: _List_Nil,
			selections: _List_Nil,
			target: 0
		},
		A2(
			$elm$random$Random$generate,
			$author$project$BinarySearch$GotRandomArray,
			A3(
...
var $author$project$BinarySearch$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$BinarySearch$GotTarget = function (a) {
	return {$: 'GotTarget', a: a};
};
...
var $author$project$BinarySearch$select = F2(
	function (i, _v0) {
		...
		var _v1 = A2($elm$core$List$member, i, selections);
		if (!_v1) {
			var pm = _Utils_eq(target, ci) ? _Utils_Tuple2(
				'Search Target found at index ' + ($elm$core$String$fromInt(i) + ' of the List.'),
				$author$project$Prompt$PromptSuccess) : ((_Utils_cmp(target, ci) < 0) ? _Utils_Tuple2(
				'The item at index ' + ($elm$core$String$fromInt(i) + (' has number ' + ($elm$core$String$fromInt(ci) + ('. It is greater than ' + ($elm$core$String$fromInt(target) + '(Search Target), search number in Left sublist.'))))),
				$author$project$Prompt$PromptInfo) : _Utils_Tuple2(
				'The item at index ' + ($elm$core$String$fromInt(i) + (' has number ' + ($elm$core$String$fromInt(ci) + ('. It is less than ' + ($elm$core$String$fromInt(target) + '(Search Target), search number in Right sublist.'))))),
				$author$project$Prompt$PromptInfo));
			return _Utils_Tuple2(
				A2($elm$core$List$cons, i, selections),
				pm);
		} else {
			return _Utils_Tuple2(
				selections,
				_Utils_Tuple2(
					'The item at index ' + ($elm$core$String$fromInt(i) + (' has number ' + ($elm$core$String$fromInt(ci) + '. It has already been selected.'))),
...
var $author$project$BinarySearch$updateShowAll = F4(
	function (selectable, ctrls, idxNumber, target) {
		if (!selectable.b) {
			var _v1 = _Utils_eq(target, idxNumber);
			if (_v1) {
				return A3(
					$author$project$Controls$updateText,
					$author$project$BinarySearch$ShowAll,
					'Target found, See all hidden numbers to verify.',
					A2($author$project$Controls$enable, $author$project$BinarySearch$ShowAll, ctrls));
			} else {
				return A3(
					$author$project$Controls$updateText,
					$author$project$BinarySearch$ShowAll,
					'Binary searched array, ' + ($elm$core$String$fromInt(target) + ' is not a member of the List'),
					A2($author$project$Controls$enable, $author$project$BinarySearch$ShowAll, ctrls));
			}
		} else {
			var x = selectable.a;
...
var $author$project$BinarySearch$binarySearch = F2(
	function (model, idx) {
		var _v0 = model;
		var numbers = _v0.numbers;
		var selections = _v0.selections;
		var ctrls = _v0.ctrls;
		var target = _v0.target;
		var selectable = _v0.selectable;
		var idxNumber = A2(
			$elm$core$Maybe$withDefault,
			-1,
			A2($elm_community$list_extra$List$Extra$getAt, idx, numbers));
		var _v1 = A2($author$project$BinarySearch$select, idx, model);
		var selections_ = _v1.a;
		var pm = _v1.b;
		if (_Utils_eq(idxNumber, target)) {
			return _Utils_update(
				model,
				{
					ctrls: A4($author$project$BinarySearch$updateShowAll, _List_Nil, ctrls, idxNumber, target),
					prompt: pm,
					selectable: _List_Nil,
					selections: selections_
				});
		} else {
			if (_Utils_cmp(idxNumber, target) < 0) {
				var selectable_ = A2(
					$elm$core$List$filter,
					$elm$core$Basics$lt(idx),
					selectable);
				return _Utils_update(
					model,
					{
						ctrls: A4($author$project$BinarySearch$updateShowAll, selectable_, ctrls, idxNumber, target),
						prompt: pm,
...
var $author$project$Common$genTarget = F2(
	function (arr, _v0) {
		var min = _v0.a;
		var max = _v0.b;
		return A2(
			...
			function (b) {
				if (!b) {
					return A2(
						...
						$elm_community$random_extra$Random$Array$sample(arr));
				} else {
					return A2($elm$random$Random$int, min, max);
				}
			},
			$elm_community$random_extra$Random$Extra$oneIn(5));
	});
...
var $author$project$BinarySearch$update = F2(
	function (msg, model) {
		var _v0 = model;
		var numbers = _v0.numbers;
		var selections = _v0.selections;
		...
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							ctrls: A3(
								...
								$author$project$BinarySearch$ShowAll,
								'',
								A2($author$project$Controls$disable, $author$project$BinarySearch$ShowAll, model.ctrls)),
							selections: $elm_community$list_extra$List$Extra$unique(
								A2(
			...
			case 'GotRandomArray':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$BinarySearch$GotTarget,
						A2(
							$author$project$Common$genTarget,
							arr,
							_Utils_Tuple2(10, 50))));
			case 'GotTarget':
				var t = msg.a;
				var pm = _Utils_Tuple2(
					'You need to search the number ' + ($elm$core$String$fromInt(t) + ' in the given list of numbers'),
					$author$project$Prompt$PromptInfo);
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'Select':
				var idx = msg.a;
				return _Utils_Tuple2(
					A2($author$project$BinarySearch$binarySearch, model, idx),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Styles$simContainerFlex = _List_fromArray(
	[
...
var $author$project$BinarySearch$NoMsg = {$: 'NoMsg'};
var $author$project$BinarySearch$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$ListView$regularFill = '#576768';
var $author$project$ListView$strokeColor = '#000';
...
var $author$project$ListView$drawCell = F8(
	function (opts, selected, inplace, idx, v, m, x, y) {
		...
		var cellColor = A2(
			...
			opts.cellColor);
		var cfn = function () {
			var _v1 = _Utils_Tuple2(selected, inplace);
			if (_v1.a) {
				if (_v1.b) {
...
var $author$project$ListView$no_options = {cellColor: $elm$core$Maybe$Nothing, hideText: false, label: $elm$core$Maybe$Nothing, labelStrokeColor: $elm$core$Maybe$Nothing, textColor: $elm$core$Maybe$Nothing};
...
var $author$project$BinarySearch$isSelectable = F2(
	function (idx, selectable) {
		return A2($elm$core$List$member, idx, selectable) ? true : false;
	});
var $author$project$ListView$Options = F5(
	function (cellColor, textColor, label, labelStrokeColor, hideText) {
		return {cellColor: cellColor, hideText: hideText, label: label, labelStrokeColor: labelStrokeColor, textColor: textColor};
	});
var $author$project$Common$bgColors = {matchFill: '#AED581', regularFill: '#576768', unMatchFill: '#F3836A'};
var $author$project$BinarySearch$numberToBGColor = F5(
	function (num, idx, selections, selectable, target) {
		var sel_idx = A2(
			$elm$core$Maybe$withDefault,
			-1,
			A2($elm_community$list_extra$List$Extra$getAt, 0, selections));
		var label_ = function () {
			var _v3 = _Utils_eq(idx, sel_idx);
			if (_v3) {
		...
		var _v0 = A2($elm$core$List$member, idx, selections);
		if (_v0) {
			var _v1 = _Utils_eq(num, target);
			if (_v1) {
				return _Utils_Tuple2(
					num,
					$elm$core$Maybe$Just(
						A5(
							$author$project$ListView$Options,
							$elm$core$Maybe$Just($author$project$Common$bgColors.matchFill),
							$elm$core$Maybe$Nothing,
							label_,
							$elm$core$Maybe$Nothing,
							false)));
				...
				return _Utils_Tuple2(
					...
					$elm$core$Maybe$Just(
						A5(
							$author$project$ListView$Options,
							$elm$core$Maybe$Just($author$project$Common$bgColors.unMatchFill),
							$elm$core$Maybe$Nothing,
							label_,
							$elm$core$Maybe$Nothing,
							false)));
			...
			var _v2 = A2($author$project$BinarySearch$isSelectable, idx, selectable);
			if (_v2) {
				return _Utils_Tuple2(
					num,
					$elm$core$Maybe$Just(
						A5(
							$author$project$ListView$Options,
							$elm$core$Maybe$Just($author$project$Common$bgColors.regularFill),
							$elm$core$Maybe$Just('GREY'),
							$elm$core$Maybe$Nothing,
							$elm$core$Maybe$Nothing,
							true)));
			} else {
...
var $author$project$BinarySearch$viewNums = F4(
	function (nums, selections, selectable, target) {
		var msg = function (ci) {
			var _v0 = A2($author$project$BinarySearch$isSelectable, ci, selectable);
			if (_v0) {
				return $author$project$BinarySearch$Select(ci);
			} else {
				return $author$project$BinarySearch$NoMsg;
			}
		};
		var lwidth = 1100;
		return A2(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								F2(
									function (pos, n) {
										return A5($author$project$BinarySearch$numberToBGColor, n, pos, selections, selectable, target);
									}),
								nums),
							selections,
							msg)
...
var $author$project$BinarySearch$viewSearchTarget = function (target) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'font-size', 'x-large'),
				A2($elm$html$Html$Attributes$style, 'background-color', '#D5FAFC'),
				A2($elm$html$Html$Attributes$style, 'padding', '0.5em')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				'Search Target : ' + $elm$core$String$fromInt(target))
			]));
};
var $author$project$BinarySearch$view = function (model) {
	var _v0 = model;
	var numbers = _v0.numbers;
	var ctrls = _v0.ctrls;
	var selections = _v0.selections;
	...
	return A2(
		$elm$html$Html$div,
		$author$project$Styles$simContainerFlex,
		_List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$author$project$BinarySearch$viewSearchTarget(target)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A4($author$project$BinarySearch$viewNums, numbers, selections, selectable, target)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2($author$project$Controls$view, ctrls, $author$project$BinarySearch$msgToString)
					]))
			]));
};
var $author$project$BinarySearch$main = $elm$browser$Browser$element(
	{init: $author$project$BinarySearch$init, subscriptions: $author$project$BinarySearch$subscriptions, update: $author$project$BinarySearch$update, view: $author$project$BinarySearch$view});
_Platform_export({'BinarySearch':{'init':$author$project$BinarySearch$main(
