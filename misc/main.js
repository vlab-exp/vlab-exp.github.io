...
var $author$project$Main$init = {k: 20000, n: '', f: 0, _: 1234};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {S: fragment, U: host, Y: path, aa: port_, ad: protocol, ae: query};
	});
				...
				return _Utils_update(
					model,
					{
						k: A2(
							...
							0,
							$elm$core$String$toInt(model.n)) + model.k,
						f: 3
					});
			default:
				return _Utils_update(
...
var $author$project$Main$AskDeposit = {$: 2};
var $author$project$Main$AskWithDraw = {$: 6};
var $author$project$Main$ShowBalance = {$: 0};
...
var $author$project$Main$GoToMainMenu = {$: 1};
						...
						_List_fromArray(
							[
								...
								'Your account has ' + ($elm$core$String$fromChar(
									$elm$core$Char$fromCode(8377)) + $elm$core$String$fromInt(model.k)))
							]))
					])),
...
var $author$project$Main$DepositMoney = {$: 4};
...
var $author$project$Main$WithDrawMoney = {$: 5};
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							...
							])) : ((model.f === 1) ? $author$project$Main$show_balance(model) : ((model.f === 2) ? $author$project$Main$ask_deposit(model) : ((model.f === 3) ? $author$project$Main$amount_deposited(model) : ((model.f === 5) ? $author$project$Main$ask_with_draw(model) : ((model.f === 6) ? $author$project$Main$amount_with_drawn(model) : $elm$html$Html$text(''))))))
					]))
			]));
};
