...
var $author$project$HeapSortAlgorithmic$GotRandomArray = function (a) {
...
var $author$project$HeapSortAlgorithmic$init = function (_v0) {
	return _Utils_Tuple2(
		{
			cBT: $elm$core$Array$fromList(_List_Nil),
			counter: 0,
			prompt: _Utils_Tuple2('Follow the Heap Sort Algorithm by clicking on \'Next\' button \r\n                    to generated a sorted list of numbers from a Max Heap', $author$project$Prompt$PromptInfo),
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$HeapSortAlgorithmic$GotRandomArray,
					A3(
...
var $author$project$HeapSortAlgorithmic$changeColor = function (n) {
	return A2(
		$elm$core$Array$map,
		function (x) {
...
var $author$project$HeapSortAlgorithmic$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotRandomArray') {
			var lst = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						selectColor: $author$project$HeapSortAlgorithmic$changeColor(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							prompt: _Utils_Tuple2('The Last node has been successfully removed and \r\n                                added to the front of generated list. Sorted List has been generated.', $author$project$Prompt$PromptSuccess),
							selectColor: $author$project$HeapSortAlgorithmic$changeColor(
				...
				if (n > 0) {
					...
					switch (_v2) {
						case 0:
							return _Utils_Tuple2(
								...
								$elm$core$Platform$Cmd$none);
						case 1:
							var _v3 = A2($author$project$Util$popAndAppend, model.cBT, model.sortedList);
							var outputCBT = _v3.a;
							var outputLst = _v3.b;
							return _Utils_Tuple2(
								_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('Sorted List has been generated.', $author$project$Prompt$PromptSuccess)
							}),
						$elm$core$Platform$Cmd$none);
				}
			}
...
var $author$project$HeapSortAlgorithmic$Next = {$: 'Next'};
...
var $author$project$HeapSortAlgorithmic$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$HeapSortAlgorithmic$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$HeapSortAlgorithmic$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$HeapSortAlgorithmic$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
...
var $author$project$HeapSortAlgorithmic$arrayItem = function (v) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$HeapSortAlgorithmic$issorted = F2(
	function (l1, l2) {
		return A2(
			$elm$core$List$all,
			function (x) {
...
var $author$project$HeapSortAlgorithmic$listView = function (lst) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								'bg-green-200',
								A2(
									$author$project$HeapSortAlgorithmic$issorted,
									lst,
				...
				_Utils_ap(
					...
					_Utils_ap(
						A2(
							...
							A2($elm$core$List$map, $author$project$HeapSortAlgorithmic$arrayItem, lst)),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$span,
...
var $author$project$HeapSortAlgorithmic$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$HeapSortAlgorithmic$drawNode,
						$author$project$HeapSortAlgorithmic$drawLine,
						A2($author$project$HeapSortAlgorithmic$createTree, 0, model)),
						$author$project$HeapSortAlgorithmic$listView(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HeapSortAlgorithmic$Next),
...
var $author$project$HeapSortAlgorithmic$main = $elm$browser$Browser$element(
	{
		init: $author$project$HeapSortAlgorithmic$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$HeapSortAlgorithmic$update,
		view: $author$project$HeapSortAlgorithmic$view
	});
_Platform_export({'HeapSortAlgorithmic':{'init':$author$project$HeapSortAlgorithmic$main(
