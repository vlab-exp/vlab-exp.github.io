...
var $author$project$HeapifyAlgorithmic$GotRandomArray = function (a) {
...
var $author$project$HeapifyAlgorithmic$init = function (_v0) {
	return _Utils_Tuple2(
		{
			cBT: $elm$core$Array$fromList(_List_Nil),
			currentNode: -1,
			highlightedNode: -1,
			prompt: _Utils_Tuple2('Click on Next button and follow the Heapify Algorithm', $author$project$Prompt$PromptInfo),
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$HeapifyAlgorithmic$GotRandomArray,
					A3(
...
var $author$project$HeapifyAlgorithmic$changeColor = F3(
	function (lst, i, j) {
		return A2(
			$elm$core$Array$map,
			function (x) {
...
var $author$project$HeapifyAlgorithmic$update = F2(
	function (msg, model) {
		if (msg.$ === 'Next') {
			if (model.currentNode >= 0) {
				...
				var next = _v1.a;
				var lst = _v1.b;
				if (_Utils_eq(next, model.highlightedNode)) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								selectColor: A3($author$project$HeapifyAlgorithmic$changeColor, model.cBT, index, index)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								selectColor: A3($author$project$HeapifyAlgorithmic$changeColor, lst, model.currentNode, next)
							}),
						$elm$core$Platform$Cmd$none);
				}
			} else {
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							prompt: _Utils_Tuple2('Complete Binary Tree has been completed into a Max Heap', $author$project$Prompt$PromptSuccess)
						}),
					$elm$core$Platform$Cmd$none);
			}
		} else {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						currentNode: index,
						highlightedNode: index,
						selectColor: A3($author$project$HeapifyAlgorithmic$changeColor, lst, index, index)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$HeapifyAlgorithmic$Next = {$: 'Next'};
...
var $author$project$HeapifyAlgorithmic$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$HeapifyAlgorithmic$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$HeapifyAlgorithmic$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$HeapifyAlgorithmic$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
...
var $author$project$HeapifyAlgorithmic$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$HeapifyAlgorithmic$drawNode,
						$author$project$HeapifyAlgorithmic$drawLine,
						A2($author$project$HeapifyAlgorithmic$createTree, 0, model)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HeapifyAlgorithmic$Next),
...
var $author$project$HeapifyAlgorithmic$main = $elm$browser$Browser$element(
	{
		init: $author$project$HeapifyAlgorithmic$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$HeapifyAlgorithmic$update,
		view: $author$project$HeapifyAlgorithmic$view
	});
_Platform_export({'HeapifyAlgorithmic':{'init':$author$project$HeapifyAlgorithmic$main(
