...
var $author$project$OrderParentChild$GotRandomArray = function (a) {
...
var $author$project$OrderParentChild$init = function (_v0) {
	return _Utils_Tuple2(
		{
			cBT: $elm$core$Array$fromList(_List_Nil),
			prompt: _Utils_Tuple2('Click on any node to toggle the selection. You can select upto two nodes.', $author$project$Prompt$PromptInfo),
			selectColor: $elm$core$Array$fromList(_List_Nil),
			selectElements: $elm$core$Array$fromList(_List_Nil)
		},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$OrderParentChild$GotRandomArray,
					A3(
...
var $author$project$OrderParentChild$getPrompt = F2(
	function (length, color) {
		switch (length) {
			case 0:
				return _Utils_Tuple2('Select two nodes to swap', $author$project$Prompt$PromptInfo);
			case 1:
				return _Utils_Tuple2('Select one more node and then click the \'Swap\' button', $author$project$Prompt$PromptInfo);
			case 2:
				return (color === 'red') ? _Utils_Tuple2('Click the \'Swap\' button to swap the selected nodes.', $author$project$Prompt$PromptInfo) : _Utils_Tuple2('Two nodes are already selected. Click on Swap button', $author$project$Prompt$PromptDanger);
			default:
				return _Utils_Tuple2('Two nodes are already selected. Click on Swap button', $author$project$Prompt$PromptDanger);
		}
	});
...
var $author$project$OrderParentChild$addPrompt = F2(
	function (model, i) {
		return _Utils_update(
			model,
			{
				prompt: A2(
					$author$project$OrderParentChild$getPrompt,
					$elm$core$Array$length(model.selectElements),
...
var $author$project$HeapUtil$isParentChild = F2(
	function (node1, node2) {
		var parent = A2($elm$core$Basics$min, node1, node2);
		var child = A2($elm$core$Basics$max, node1, node2);
		return _Utils_eq(child, (2 * parent) + 1) ? true : (_Utils_eq(child, (2 * parent) + 2) ? true : false);
	});
...
var $author$project$OrderParentChild$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Select':
				var i = msg.a;
				return (A2($author$project$Util$getForString, model.selectColor, i) === 'red') ? _Utils_Tuple2(
					A2(
						$author$project$OrderParentChild$addPrompt,
						_Utils_update(
							model,
							{
								selectColor: A3($elm$core$Array$set, i, 'black', model.selectColor),
								selectElements: A2(
						...
						i),
					$elm$core$Platform$Cmd$none) : (($elm$core$Array$length(model.selectElements) < 2) ? _Utils_Tuple2(
					A2(
						$author$project$OrderParentChild$addPrompt,
						_Utils_update(
							model,
							{
								selectColor: A3($elm$core$Array$set, i, 'red', model.selectColor),
								selectElements: A2($elm$core$Array$push, i, model.selectElements)
							}),
						i),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					A2($author$project$OrderParentChild$addPrompt, model, i),
					$elm$core$Platform$Cmd$none));
			case 'Swap':
				if ($elm$core$Array$length(model.selectElements) < 2) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('Select Exactly two nodes', $author$project$Prompt$PromptDanger)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var node2 = A2($author$project$Util$getForInt, model.selectElements, 1);
					var node1 = A2($author$project$Util$getForInt, model.selectElements, 0);
					var parentIndex = A2($elm$core$Basics$min, node1, node2);
					var parentValue = A2($author$project$Util$getForInt, model.cBT, parentIndex);
					var childIndex = A2($elm$core$Basics$max, node1, node2);
					var childValue = A2($author$project$Util$getForInt, model.cBT, childIndex);
					return A2($author$project$HeapUtil$isParentChild, node1, node2) ? ((!A2($author$project$HeapUtil$isValidChild, parentValue, childValue)) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								cBT: A2($author$project$Util$swap, model.cBT, model.selectElements),
								prompt: _Utils_Tuple2('Nodes have been successfully swaped. Select two nodes to swap', $author$project$Prompt$PromptSuccess),
								selectColor: A2(
						...
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('The value at Parent node should be smaller than the child node. Select two nodes to swap', $author$project$Prompt$PromptDanger),
								selectColor: A2(
									$elm$core$Array$repeat,
									$elm$core$Array$length(model.cBT),
									'black'),
						...
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('Selected Nodes don\'t have Parent-Child relationship. Select two nodes to swap', $author$project$Prompt$PromptDanger),
								selectColor: A2(
									$elm$core$Array$repeat,
									$elm$core$Array$length(model.cBT),
									'black'),
...
var $author$project$OrderParentChild$Swap = {$: 'Swap'};
...
var $author$project$OrderParentChild$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$OrderParentChild$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$OrderParentChild$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$OrderParentChild$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$OrderParentChild$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$OrderParentChild$Select(i))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$OrderParentChild$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$OrderParentChild$drawNode,
						$author$project$OrderParentChild$drawLine,
						A2($author$project$OrderParentChild$createTree, 0, model)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$OrderParentChild$Swap),
...
var $author$project$OrderParentChild$main = $elm$browser$Browser$element(
	{
		init: $author$project$OrderParentChild$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$OrderParentChild$update,
		view: $author$project$OrderParentChild$view
	});
_Platform_export({'OrderParentChild':{'init':$author$project$OrderParentChild$main(
