...
var $author$project$Swapping$GotRandomArray = function (a) {
...
var $author$project$Swapping$init = function (_v0) {
	return _Utils_Tuple2(
		{
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$Swapping$GotRandomArray,
					A3(
...
var $author$project$Swapping$getPrompt = F2(
...
var $author$project$Swapping$addPrompt = F2(
	function (model, i) {
		return _Utils_update(
			model,
			{
				prompt: A2(
					$author$project$Swapping$getPrompt,
...
var $author$project$Swapping$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Select':
				var i = msg.a;
				return (A2($author$project$Util$getForString, model.selectColor, i) === 'red') ? _Utils_Tuple2(
					A2(
						$author$project$Swapping$addPrompt,
						_Utils_update(
							model,
							{
					...
					A2($author$project$Swapping$addPrompt, model, i),
					$elm$core$Platform$Cmd$none));
			case 'Swap':
				return ($elm$core$Array$length(model.selectElements) < 2) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var $author$project$Swapping$Swap = {$: 'Swap'};
...
var $author$project$Swapping$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$Swapping$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$Swapping$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$Swapping$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$Swapping$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Swapping$Select(i))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Swapping$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Swapping$drawNode,
						$author$project$Swapping$drawLine,
						A2($author$project$Swapping$createTree, 0, model)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Swapping$Swap),
...
var $author$project$Swapping$main = $elm$browser$Browser$element(
	{
		init: $author$project$Swapping$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Swapping$update,
		view: $author$project$Swapping$view
	});
_Platform_export({'Swapping':{'init':$author$project$Swapping$main(
