...
var $author$project$HeapifyInteractive$GotRandomArray = function (a) {
...
var $author$project$HeapifyInteractive$init = function (_v0) {
	return _Utils_Tuple2(
		{
			cBT: $elm$core$Array$fromList(_List_Nil),
			currentNode: -1,
			highlightedNode: -1,
			prompt: _Utils_Tuple2('Click on \'Heapify\' button to correct the highlighted node or\r\n      Click on \'Decr\' button to make previous node as the root of the sub-tree under consideration', $author$project$Prompt$PromptInfo),
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$HeapifyInteractive$GotRandomArray,
					A3(
...
var $author$project$HeapifyInteractive$changeColor = F3(
	function (lst, i, j) {
		return A2(
			$elm$core$Array$map,
			function (x) {
...
var $author$project$Util$heapifyAlgo = F2(
	function (lst, index) {
...
var $author$project$HeapifyInteractive$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Decr':
				if (model.currentNode > 0) {
					var index = model.currentNode - 1;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								prompt: _Utils_Tuple2('Root of the sub-tree to be processed has been succesfully \r\n                    changed to the previous node', $author$project$Prompt$PromptSuccess),
								selectColor: A3($author$project$HeapifyInteractive$changeColor, model.cBT, index, index)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('Current node doesn\'t have any previous node. \r\n                    Therefore, this operation cannot be performed. Check if CBT is also a Max-heap, \r\n                    if not, Click on Reset button', $author$project$Prompt$PromptDanger)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Reset':
				var index = (($elm$core$Array$length(model.cBT) / 2) | 0) - 1;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentNode: index,
							highlightedNode: index,
							prompt: _Utils_Tuple2('The root of the sub-tree to be processed \r\n                has been successfully changed to the last parent node.', $author$project$Prompt$PromptSuccess),
							selectColor: A3($author$project$HeapifyInteractive$changeColor, model.cBT, index, index)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Heapify':
				if (model.currentNode >= 0) {
					var _v1 = A2($author$project$Util$heapifyAlgo, model.cBT, model.highlightedNode);
					var next = _v1.a;
					var lst = _v1.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								prompt: _Utils_Tuple2('Current node has been corrected. \r\n                Either click on \'Decr\' button to make previous node as the root of the sub-tree under consideration or \r\n                click on \'Heapify\' to correct the highlighted node or\r\n                click on \'Reset\' to get back to the last parent node.', $author$project$Prompt$PromptSuccess),
								selectColor: A3($author$project$HeapifyInteractive$changeColor, lst, model.currentNode, next)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('This operation cannot be performed.', $author$project$Prompt$PromptSuccess)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				var lst = msg.a;
				var index = (($elm$core$Array$length(lst) / 2) | 0) - 1;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							currentNode: index,
							highlightedNode: index,
							selectColor: A3($author$project$HeapifyInteractive$changeColor, lst, index, index)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$HeapifyInteractive$Decr = {$: 'Decr'};
var $author$project$HeapifyInteractive$Heapify = {$: 'Heapify'};
var $author$project$HeapifyInteractive$Reset = {$: 'Reset'};
...
var $author$project$HeapifyInteractive$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$HeapifyInteractive$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$HeapifyInteractive$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$HeapifyInteractive$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
...
var $author$project$HeapifyInteractive$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$HeapifyInteractive$drawNode,
						$author$project$HeapifyInteractive$drawLine,
						A2($author$project$HeapifyInteractive$createTree, 0, model)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HeapifyInteractive$Decr),
						...
						_List_fromArray(
							[
								$elm$svg$Svg$text('Decr')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HeapifyInteractive$Heapify),
								$elm$html$Html$Attributes$class('bg-gray-600'),
								$elm$html$Html$Attributes$class('text-gray-100'),
								$elm$html$Html$Attributes$class('p-2')
							]),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HeapifyInteractive$Reset),
								$elm$html$Html$Attributes$class('bg-gray-600'),
								$elm$html$Html$Attributes$class('text-gray-100'),
								$elm$html$Html$Attributes$class('p-2')
							]),
...
var $author$project$HeapifyInteractive$main = $elm$browser$Browser$element(
	{
		init: $author$project$HeapifyInteractive$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$HeapifyInteractive$update,
		view: $author$project$HeapifyInteractive$view
	});
_Platform_export({'HeapifyInteractive':{'init':$author$project$HeapifyInteractive$main(
