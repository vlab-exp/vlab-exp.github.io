...
var $author$project$HeapifySubtree$GotRandomArray = function (a) {
...
var $author$project$HeapifySubtree$init = function (_v0) {
	return _Utils_Tuple2(
		{
			cBT: $elm$core$Array$fromList(_List_Nil),
			currentNode: -1,
			highlightedNode: -1,
			prompt: _Utils_Tuple2('Click on any node to toggle the selection. You can select only one node.', $author$project$Prompt$PromptInfo),
			selectColor: $elm$core$Array$fromList(_List_Nil),
			selectedNode: -1
		},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$HeapifySubtree$GotRandomArray,
					A3(
...
var $author$project$HeapifySubtree$changeColor = F3(
	function (lst, i, j) {
		return A2(
			$elm$core$Array$map,
			function (x) {
				return _Utils_eq(x, i) ? 'red' : (_Utils_eq(x, j) ? 'green' : 'black');
			},
			A2(
				$elm$core$Array$initialize,
				$elm$core$Array$length(lst),
...
var $author$project$Util$getForInt = F2(
	function (array, i) {
		return A2(
...
var $author$project$Util$larger = F3(
	function (lst, parent, child) {
		var parentValue = A2($author$project$Util$getForInt, lst, parent);
		var childValue = A2($author$project$Util$getForInt, lst, child);
		return _Utils_eq(childValue, -1) ? parent : ((_Utils_cmp(childValue, parentValue) > 0) ? child : parent);
	});
var $author$project$Util$largest = F2(
	function (lst, parent) {
		var rightChild = (2 * parent) + 2;
		var right = A3($author$project$Util$larger, lst, parent, rightChild);
		var rightValue = A2($author$project$Util$getForInt, lst, right);
		var leftChild = (2 * parent) + 1;
		var left = A3($author$project$Util$larger, lst, parent, leftChild);
		var leftValue = A2($author$project$Util$getForInt, lst, left);
		return (_Utils_cmp(leftValue, rightValue) > -1) ? left : right;
	});
...
var $author$project$Util$swap = F2(
	function (lst, indexes) {
		var index2 = A2($author$project$Util$getForInt, indexes, 1);
		var val2 = A2($author$project$Util$getForInt, lst, index2);
		var index1 = A2($author$project$Util$getForInt, indexes, 0);
		var val1 = A2($author$project$Util$getForInt, lst, index1);
		return A3(
			$elm$core$Array$set,
			index2,
			val1,
			A3($elm$core$Array$set, index1, val2, lst));
	});
var $author$project$Util$heapify = F2(
	function (lst, index) {
		var output = A2($author$project$Util$largest, lst, index);
		return (!_Utils_eq(output, index)) ? _Utils_Tuple3(
			true,
			output,
			A2(
				$author$project$Util$swap,
				lst,
				$elm$core$Array$fromList(
					_List_fromArray(
						[index, output])))) : _Utils_Tuple3(false, -1, lst);
	});
var $author$project$Util$isCorrect = F2(
	function (lst, index) {
		var output = A2($author$project$Util$largest, lst, index);
		return (!_Utils_eq(output, index)) ? false : true;
	});
var $author$project$HeapUtil$isLeaf = F2(
	function (i, n) {
		return (_Utils_cmp((2 * i) + 1, n) < 0) ? false : true;
	});
...
var $author$project$HeapifySubtree$selectable = F2(
	function (lst, index) {
		return A2(
			$author$project$HeapUtil$isLeaf,
			index,
			$elm$core$Array$length(lst)) ? false : (A2($author$project$Util$isCorrect, lst, index) ? false : true);
	});
var $author$project$HeapifySubtree$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Select':
				var i = msg.a;
				return _Utils_eq(model.selectedNode, -1) ? ((!A2($author$project$HeapifySubtree$selectable, model.cBT, i)) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							prompt: _Utils_Tuple2('This node cannot be selected. Select a node which is either not a Leaf or an incorrect node', $author$project$Prompt$PromptDanger),
							selectColor: A3($author$project$HeapifySubtree$changeColor, model.cBT, i, -1)
						}),
					...
					_Utils_update(
						model,
						{
							currentNode: i,
							highlightedNode: i,
							prompt: _Utils_Tuple2('Node has been selected. Click on Heapify button to correct it.', $author$project$Prompt$PromptInfo),
							selectColor: A3($author$project$HeapifySubtree$changeColor, model.cBT, i, i),
							selectedNode: i
						}),
					$elm$core$Platform$Cmd$none)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							prompt: _Utils_Tuple2('Complete heapifying the current sub-tree before moving on to another.', $author$project$Prompt$PromptDanger)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Heapify':
				if (_Utils_eq(model.selectedNode, -1)) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('Select a node and then click on Heapify button', $author$project$Prompt$PromptDanger)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v1 = A2($author$project$Util$heapify, model.cBT, model.highlightedNode);
					var flag = _v1.a;
					var next = _v1.b;
					var lst = _v1.c;
					return flag ? (A2(
						$author$project$HeapUtil$isLeaf,
						next,
						$elm$core$Array$length(lst)) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								cBT: lst,
								prompt: _Utils_Tuple2('You have reached the end of the sub-tree. Select any other node', $author$project$Prompt$PromptInfo),
								selectColor: A3($author$project$HeapifySubtree$changeColor, model.cBT, model.currentNode, next),
								selectedNode: -1
							}),
						$elm$core$Platform$Cmd$none) : (A2($author$project$Util$isCorrect, lst, next) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								cBT: lst,
								prompt: _Utils_Tuple2('You have reached the a correct node. Select any other node', $author$project$Prompt$PromptInfo),
								selectColor: A3($author$project$HeapifySubtree$changeColor, model.cBT, model.currentNode, next),
								selectedNode: -1
							}),
						$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							...
							{
								cBT: lst,
								highlightedNode: next,
								prompt: _Utils_Tuple2('Current node has been corrected. Click on Heapify button to correct the highlighted node', $author$project$Prompt$PromptSuccess),
								selectColor: A3($author$project$HeapifySubtree$changeColor, model.cBT, model.currentNode, next)
							}),
						$elm$core$Platform$Cmd$none))) : _Utils_Tuple2(
						_Utils_update(
							...
							{
								cBT: lst,
								prompt: _Utils_Tuple2('Selected Node doesn\'t need any correction. Select another node', $author$project$Prompt$PromptDanger),
								selectColor: A2(
									$elm$core$Array$repeat,
									$elm$core$Array$length(model.cBT),
									'black'),
								selectedNode: -1
							}),
						$elm$core$Platform$Cmd$none);
...
var $author$project$HeapifySubtree$Heapify = {$: 'Heapify'};
...
var $author$project$Util$getForString = F2(
	function (array, i) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
...
var $author$project$HeapifySubtree$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			$elm$core$Array$length(model.cBT)) < 0) {
			var children = A2(
			...
			return A2(
				...
				_Utils_Tuple3(
					A2($author$project$Util$getForInt, model.cBT, i),
					i,
					A2($author$project$Util$getForString, model.selectColor, i)),
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$HeapifySubtree$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$HeapifySubtree$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$HeapifySubtree$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$HeapifySubtree$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$HeapifySubtree$Select(i))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$stroke(curColor),
...
var $author$project$HeapUtil$isValidChild = F2(
	function (parent, child) {
		return _Utils_eq(child, -1) ? true : ((_Utils_cmp(parent, child) > -1) ? true : false);
	});
var $author$project$HeapUtil$isHeap = F2(
	function (lst, i) {
		isHeap:
		while (true) {
			var rightChild = A2($author$project$Util$getForInt, lst, (2 * i) + 2);
			var parent = A2($author$project$Util$getForInt, lst, i);
			var leftChild = A2($author$project$Util$getForInt, lst, (2 * i) + 1);
			if (A2($author$project$HeapUtil$isValidChild, parent, leftChild)) {
				if (A2($author$project$HeapUtil$isValidChild, parent, rightChild)) {
					if (i > 0) {
						var $temp$lst = lst,
							$temp$i = i - 1;
						lst = $temp$lst;
...
var $author$project$HeapUtil$getHeapStatus = function (heap) {
	var status = (!$elm$core$Array$length(heap)) ? false : (($elm$core$Array$length(heap) === 1) ? true : A2(
		$author$project$HeapUtil$isHeap,
		heap,
		(($elm$core$Array$length(heap) / 2) | 0) - 1));
	return status ? _Utils_Tuple2('Max Heap', '#33cc33') : _Utils_Tuple2('Complete Binary Tree', '#ff6600');
};
var $elm$html$Html$p = _VirtualDom_node('p');
var $author$project$HeapUtil$showHeapStatus = function (heap) {
	var _v0 = $author$project$HeapUtil$getHeapStatus(heap);
	var message = _v0.a;
	var color = _v0.b;
	return A2(
		$elm$html$Html$p,
...
var $author$project$HeapifySubtree$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$HeapifySubtree$drawNode,
						$author$project$HeapifySubtree$drawLine,
						A2($author$project$HeapifySubtree$createTree, 0, model)),
						$author$project$HeapUtil$showHeapStatus(model.cBT)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HeapifySubtree$Heapify),
						...
						_List_fromArray(
							[
								$elm$svg$Svg$text('Heapify')
							]))
					]))
			]));
};
var $author$project$HeapifySubtree$main = $elm$browser$Browser$element(
	{
		init: $author$project$HeapifySubtree$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$HeapifySubtree$update,
		view: $author$project$HeapifySubtree$view
	});
_Platform_export({'HeapifySubtree':{'init':$author$project$HeapifySubtree$main(
