...
var $author$project$Correction$GotRandomArray = function (a) {
...
var $author$project$Correction$init = function (_v0) {
	return _Utils_Tuple2(
		{
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$Correction$GotRandomArray,
					A3(
...
var $author$project$Util$correct = F2(
	function (lst, index) {
		var output = A2($author$project$Util$largest, lst, index);
		return (!_Utils_eq(output, index)) ? _Utils_Tuple2(
			true,
			A2(
				...
				$elm$core$Array$fromList(
					_List_fromArray(
						[index, output])))) : _Utils_Tuple2(false, lst);
	});
...
var $author$project$Correction$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Select':
				var i = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							prompt: _Utils_Tuple2('Node has been selected. Click on Correct button to correct it.', $author$project$Prompt$PromptInfo),
							selectColor: A2(
								$elm$core$Array$map,
								function (x) {
									return _Utils_eq(x, i) ? 'red' : 'black';
								},
								A2(
									$elm$core$Array$initialize,
				...
				if (_Utils_eq(model.selectedNode, -1)) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								prompt: _Utils_Tuple2('Select a node and then click on Correct button', $author$project$Prompt$PromptDanger)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v1 = A2($author$project$Util$correct, model.cBT, model.selectedNode);
					var flag = _v1.a;
					var lst = _v1.b;
					return flag ? _Utils_Tuple2(
						_Utils_update(
							...
							{
								cBT: lst,
								prompt: _Utils_Tuple2('Selected Node has been corrected. Select another node', $author$project$Prompt$PromptSuccess),
								selectColor: A2(
...
var $author$project$Correction$Correct = {$: 'Correct'};
...
var $author$project$Correction$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$Correction$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$Correction$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$Correction$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$Correction$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Correction$Select(i))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Correction$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Correction$drawNode,
						$author$project$Correction$drawLine,
						A2($author$project$Correction$createTree, 0, model)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Correction$Correct),
						...
						_List_fromArray(
							[
								$elm$svg$Svg$text('Correct')
							]))
					]))
			]));
};
var $author$project$Correction$main = $elm$browser$Browser$element(
	{
		init: $author$project$Correction$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Correction$update,
		view: $author$project$Correction$view
	});
_Platform_export({'Correction':{'init':$author$project$Correction$main(
