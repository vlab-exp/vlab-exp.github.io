...
var $author$project$ParentChild$GotRandomArray = function (a) {
...
var $author$project$ParentChild$init = function (_v0) {
	return _Utils_Tuple2(
		{
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					$author$project$ParentChild$GotRandomArray,
					A3(
...
var $author$project$ParentChild$getPrompt = F2(
...
var $author$project$ParentChild$addPrompt = F2(
	function (model, i) {
		return _Utils_update(
			model,
			{
				prompt: A2(
					$author$project$ParentChild$getPrompt,
...
var $author$project$ParentChild$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Select':
				var i = msg.a;
				return (A2($author$project$Util$getForString, model.selectColor, i) === 'red') ? _Utils_Tuple2(
					A2(
						$author$project$ParentChild$addPrompt,
						_Utils_update(
							model,
							{
					...
					A2($author$project$ParentChild$addPrompt, model, i),
			...
			case 'Swap':
				if ($elm$core$Array$length(model.selectElements) < 2) {
					...
					return A2($author$project$HeapUtil$isParentChild, node1, node2) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
...
var $author$project$ParentChild$Swap = {$: 'Swap'};
...
var $author$project$ParentChild$createTree = F2(
	function (i, model) {
		if (_Utils_cmp(
			i,
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (idx) {
						return A2($author$project$ParentChild$createTree, idx, model);
					},
					children));
		} else {
			return A2(
...
var $author$project$ParentChild$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		$elm$svg$Svg$line,
...
var $author$project$ParentChild$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$ParentChild$drawNode = function (_v0) {
	var n = _v0.a;
	var i = _v0.b;
	var curColor = _v0.c;
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$ParentChild$Select(i))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$ParentChild$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$ParentChild$drawNode,
						$author$project$ParentChild$drawLine,
						A2($author$project$ParentChild$createTree, 0, model)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$ParentChild$Swap),
...
var $author$project$ParentChild$main = $elm$browser$Browser$element(
	{
		init: $author$project$ParentChild$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ParentChild$update,
		view: $author$project$ParentChild$view
	});
_Platform_export({'ParentChild':{'init':$author$project$ParentChild$main(
